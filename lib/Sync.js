  ...
  async.series([
      ...
      function(c) {
        ...
        self.bDb.has(newPrev, function(err, val) {
          // Genesis? no problem
		  if (!val && (newPrev === '00000b97ae4a916b25c985de119295e2d466c3022bba1ebd8ca665e4c315fbf9' || newPrev.match(/^0+$/))) {
            return c();
          }
          return c(err || (!val ? new Error('NEED_SYNC Ignoring block with non existing prev:' + b.hash) : null));
        });
      },
      function(c) {
