...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.shmninsight');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\shmn\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/shmn/';
  if (isLinux) dataDir = process.env.HOME + '/.shmn/';
}
